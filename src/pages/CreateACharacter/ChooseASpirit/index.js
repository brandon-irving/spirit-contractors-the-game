...
const spirits = [
  {
    ...
    element: 'None',
    abilities: [
      { name: 'Luck Purchase', desc: 'You can sell hp to increase your roll boost. Every 5hp is +1'},
      { name: 'Gambling Foot', desc: 'You can bet some of your hp on a second chance to roll'}
    ],
    img: 'https://image.shutterstock.com/image-illustration/portrait-hare-suit-hand-drawn-260nw-330857777.jpg',
    strategy: 'Hp is always a currency Lucky accepts, so stay near a healer and have plenty of potions around. If you ever come across something valuable, try haggling. With a silver tongue and some luck, you just might strike a deal with this bunny!'
  },
  {
    ...
    element: 'Shade',
    abilities: [
      { name: 'Shadow Armor:', desc: 'Your str, spd, and def boost when in the shadows'},
      { name: 'Shady Travels', desc: 'You can travel to any one shadow, once per day but you lose shadow armor for 24hrs'}
    ],
    img: 'https://image.shutterstock.com/image-illustration/dark-dragon-stone-background-260nw-1836182665.jpg',
    strategy: 'Shadows are your friend! Suggest attacking at night or try to lure foes to shady areas or around big infrastructures. Your Shady Travel can either be an escape tactic or something you can use to get to hard to reach places!'
  },
  {
    name: 'Shining Mantis',
    ...
    element: 'Shine',
    abilities: [
      { name: 'Shining Justice', desc: 'Your str, spd, and def boost when in the light'},
      { name: 'Light Shield:', desc: 'You can create a shield of light to defend against attacks (the more the light the stronger the shield max: 5)'}
    ],
    img: 'https://image.shutterstock.com/image-photo/futuristic-space-particles-bright-round-260nw-1357818467.jpg',
    strategy: 'Stay in the light or create light. Maybe purchase a flashlight or a lamp before you head into battle. Avoid leading the charge at night and if you need to, keep a flash bang handy!'
  },
  {
    name: 'Frost Tiger',
    ...
    element: 'Frost',
    abilities: [
      { name: 'Freezing', desc: 'You can freeze moderate amounts of water per action'},
      { name: 'Frost Launch', desc: 'You can launch your ice 15ft straight. The damage of the ice depends on its size'}
    ],
    img: 'https://image.shutterstock.com/image-photo/black-white-beautiful-tiger-isolated-260nw-385167907.jpg',
    strategy: 'Strategy: Bring water bottles, jugs, whatever you can think of that can carry water. You can also freeze water into weapons, tools, etc. Get creative and try to be as flexible as water!'
  },
  {
    name: 'Amber Scales',
    ...
    element: 'None',
    abilities: [
      { name: 'Balanced Thoughts', desc: 'You can ask for one hint in any situation'},
      { name: 'True Balance', desc: 'You can add your hp and mp, then divide them evenly. Can only be done once every 24hrs'}
    ],
    img: 'https://image.shutterstock.com/image-photo/statue-justice-symbol-legal-law-260nw-681265648.jpg',
    strategy: 'This ability is perfect for a support character (like a healer or long ranged fighter). With your balanced thoughts, you can quickly deduce a monsters weakness and with true balance, you can save yourself in a pinch! '
  },
  {
    name: 'Aquatica Orca',
    ...
    element: 'Water',
    abilities: [
      { name: 'Child of Water', desc: 'Water you yield has healing properties, you are also healed while in natural water'},
    ...
    strategy: 'This ability is for a healing character. Stay within range of an attacker and heal them as they defend you. Keeping cantenes of water will prove useful and basing your strategies around being near large bodies of water will be ideal'
  },
  {
    ...
    element: 'None',
    abilities: [
      { name: 'Transmutation', desc: 'You can gather material and change it into something else'},
    ],
    img: 'https://image.shutterstock.com/image-photo/fantasy-witch-wizard-woman-using-260nw-1658387587.jpg',
    strategy: 'This ability is exceptionally versatile but it heavily relies on your knowledge of alchemy, biology, earth metals, etc. Before going into battle, try going to a school, library or workshop and gain knowledge. This will make your ability extraordinarily useful'
  },
...
function handleSpiritClick(spirit){
  ...
  return (
    <>
    <Text align='center'>
    Some spirits see the gradual decline to cataclysm, some simply want an adventure. Whatever the reason
    these spirits have agreed to form a contract with you. Choose the spirit you most resonate with!
      ...
      <Modal onClose={onClose} size={'full'} isOpen={isOpen}>
        ...
        >
          ...
          <ModalCloseButton />
          <ModalBody>
              <SpiritInfo selectedSpirit={selectedSpirit} setselectedSpirit={setselectedSpirit} closeModal={onClose} spirit={spirit} />
          </ModalBody>
        </ModalContent>
      </Modal>
      </>
